...
# art -> cap
# Polina aged
C_Lac_a = 0.8152173913043479 #0.55 #0.55 - 0.10113109309463841 #0.6 #0.82 #0.55 #0.815 #Lac_b0 #0.82 #Lac_b0 - 0.10113109309463841 #0.82 #1.22 #1.6 #0.82 #1.222 # 0.5 #1.225 #1.22 #1.25 #1.0 #0.85 # #0.82 #0.5 Jolivet2015 # 1. #0.9 #1.0 # Leegsma-Vogt PMID: 11746404 #0.82 # set slightly higher than Lac_b from http://dx.doi.org/10.1016/j.cmet.2015.10.010 

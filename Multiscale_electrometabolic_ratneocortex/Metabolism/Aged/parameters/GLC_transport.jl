#Polina aged
C_Glc_a = 5.0 #C_Glc_a = 4.65 #4.75 #5.2 #5.25 #5.5 # DOI 10.1002/glia # 4.75 in Jolivet # 4.8 Winter2017Copasi  #5.5 #Glc_b0 + 0.5    #Glc_b0 + 0.8 # aprox from Calvetti and Nehlig1992  # check it 

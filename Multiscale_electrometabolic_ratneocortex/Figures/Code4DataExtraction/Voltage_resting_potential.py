...
result_path ='/gpfs/bbp.cscs.ch/data/project/proj137/farinaNGV/Paper_results/my_simulation/reporting_metabolism_aged/ndam_v.h5'
...
df.to_csv('./Data/voltage_rest_aged.csv', index=False)

...
def Compute_area(cell_id):
    ...
    # Read all info to build the cells
    hoc_name = cell1['model_template'].replace("hoc:", "")
    hoc_file = "/gpfs/bbp.cscs.ch/project/proj137/home/mandge/optimisation/release/v3/"+hoc_name +".hoc" # hocfile can be found "../../emodels/v3/"
    morph_file ="/gpfs/bbp.cscs.ch/project/proj83/entities/fixed-ais-L23PC-2020-12-10/ascii/" + str(cell1['morphology']) + '.asc' # Can be downloaded 10.5281/zenodo.8155899
...
# read Circuit
circuit = bluepysnap.Circuit('../../circuit_config.json') 
